...
import "grpc/ProjectBloggingServiceUsingMongoAndGrpc/blogpb"
...
func main() {
	...
	fmt.Printf("Blog has been created: %v", CrtblogRes)
	blogID := CrtblogRes.GetBlog().GetId()

	// Read Blog
	fmt.Println("Reading the blog")

	_, err2 := c.ReadBlog(context.Background(), &blogpb.ReadBlogRequest{BlogId: "5e089c9664bac50091392359"}) // 5bdc29e661b75adcac496cf4 wrong BlogID
	if err2 != nil {
